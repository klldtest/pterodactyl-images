...
RUN apk add --no-cache --update --repository=http://dl-cdn.alpinelinux.org/alpine/edge/testing/ build-base xz php8 python3 ffmpeg libffi-dev py3-libnacl opus opus-dev
